...
export function SignupForm() {
  ...
  return (
    <form action={onSubmit} className="auth-form" noValidate>
      <label htmlFor="displayName">نام نمایشی <span aria-hidden="true">(اختیاری)</span></label>
      <input id="displayName" name="displayName" autoComplete="name" maxLength={120} />
      <label htmlFor="username">نام کاربری</label>
      <input id="username" name="username" autoComplete="username" required minLength={3} maxLength={30} pattern="[a-z0-9_-]+" dir="ltr" />
