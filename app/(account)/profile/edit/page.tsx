...
export default async function EditProfilePage() {
  ...
  return <main id="main-content" className="account-page page-shell"><section className="account-card" aria-labelledby="edit-profile-title"><h1 id="edit-profile-title">ویرایش پروفایل</h1><ProfileForm profile={{ ...profile, displayName: profile.displayName ?? session.user.username, preferredLocale: profile.preferredLocale as "fa" | "en" }} /></section></main>;
}
